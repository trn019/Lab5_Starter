...
2. I would use a unit test to the "max message length" feature of a message application because it is important to see if a message meets certain conditions (like character limits) or else they can't be sent. I would test if the program would provide me a false value for a message is above the limit.